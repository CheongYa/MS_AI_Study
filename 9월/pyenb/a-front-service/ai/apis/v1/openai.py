...
from ai.models.openai import OpenaiMessage
...
class OpenaiMessageView(APIView):
    ...
    def get(self, request):
        ...
        message_queryset = message_queryset.reverse()

        message_list = list()
        temp = ["", ""]

        for index in (0, pre_message_count):
            c = message_queryset[index]
            temp[index % 2] = c.message
